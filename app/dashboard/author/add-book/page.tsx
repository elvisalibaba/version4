...
export default async function AddBookPage() {
  ...
  return (
    <section className="space-y-6">
      <header className="rounded-[28px] bg-[#173d2c] p-6 text-white sm:p-8"><Link href="/dashboard/author/books" className="inline-flex items-center gap-2 text-sm font-bold text-white/70 hover:text-white"><ArrowLeft className="h-4 w-4" />Mes livres</Link><p className="mt-7 text-xs font-bold uppercase tracking-[.2em] text-[#f2c66f]">Nouvelle publication</p><h1 className="mt-3 font-serif text-3xl sm:text-4xl">Ajouter jusqu’à trois livres</h1><p className="mt-2 max-w-xl text-sm leading-6 text-white/65">Importez vos PDF ou EPUB : leur première page devient la couverture. Suivez le chargement, puis envoyez vos livres pour vérification.</p></header>
